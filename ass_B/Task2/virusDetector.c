...
link* fix_file(link* list, const char* fileName){ //  עוברים על כל בייט בפייל, ולהשוות מאותו הבייט ה-איי עם כל אחד  מהוירוסים בליסט ואם יש התאמה צריך לתקן כמו בדידקט רק לא להדפיס אלא לשנות.ן.
...
int main(int argc, char **argv) {
  link* list = NULL;
  FILE* file=NULL;
  struct newMenu menu[] = {{"Load signatures",load_signatures},{"Print signatures",print_signatures},{"Detect viruses",detect_viruses},{"fix file",fix_file},{"Quit",quit},{NULL, NULL}}; // need to add detect, fix, quit!!
